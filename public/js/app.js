var AppProcess = (function () {
    ...
    function eventProcess() {
        ...
        $("#videoCamOnOffMob").on("click", async function () {
            removeVideoStream(rtp_vid_senders);
            if (video_st == video_states.Camera) {
                await videoProcess(video_states.None);
            } else {
    ...
    async function videoProcess(newVideoState) {
        ...
        try {
            ...
            if (newVideoState == video_states.Camera) {
                ...
                vstream.oninactive = (e) => {
                    ...
                    $("#ScreenShareOnOf").html(
                        '<span class="material-icons screen-icon" style="width: 100%;">web_asset_off</span>'
                    );
        ...
        if (newVideoState == video_states.Camera) {
            ...
            $("#ScreenShareOnOf").html(
                '<span class="material-icons screen-icon" style="width: 100%;">web_asset</span>'
            );
            $("#ScreenShareOnOfMob").html(
                '<span class="material-icons screen-icon" style="width: 100%;">web_asset</span>'
            );
