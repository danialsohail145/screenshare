$(function() {
    $(document).on("click", ".create-meeting", function() {
        ...
        // console.log(document.querySelector(".diabledId").innerHTML);
        // alert(document.querySelector(".diabledId").innerHTML);
        
        var eight_d_value = document.querySelector(".diabledId").innerHTML; //12345678;
